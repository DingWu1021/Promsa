...
export MODEL_PATH="/path/to/models/Qwen3-VL-8B-Instruct"
# export MODEL_PATH="/path/to/models/Qwen3-VL-32B-Instruct"
...
# If you use Azure GPT judge, set this. If you use local judge (8181), you can leave it unset.
# export AZURE_OPENAI_API_KEY="<YOUR_AZURE_OPENAI_KEY>"
export LLM_JUDGE_URL="127.0.0.1:8181"
# For SGLang/vLLM OpenAI-compatible servers, API key is typically ignored; any placeholder works.
export LLM_JUDGE_API_KEY="token-abc123"
# ==========================================================================
...
train_files=/path/to/workspace/ECCV/KBSearch-v4/train_infoseek_val.json
val_files=/path/to/workspace/ECCV/KBSearch-v4/test_infoseek_val_v1.json

model_name=$(basename "$MODEL_PATH")
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
exp_name=ProMSA_eval_${model_name}_${TIMESTAMP}

mkdir -p $(dirname $0)/rollout_data_PPU/$exp_name/train
mkdir -p $(dirname $0)/rollout_data_PPU/$exp_name/validation
...
python3 -m verl.trainer.main_ppo \
    ...
    +reward_model.val_reward_kwargs.llm_judge_model='Qwen-vl-32b' \
    +reward_model.val_reward_kwargs.llm_judge_urls=["${LLM_JUDGE_URL}"] \
    +reward_model.val_reward_kwargs.llm_judge_api_key="${LLM_JUDGE_API_KEY}" \
    ...
    trainer.test_freq=0 \
    trainer.rollout_data_dir=$(dirname $0)/rollout_data_PPU/$exp_name/train \
    trainer.validation_data_dir=$(dirname $0)/rollout_data_PPU/$exp_name/validation \
